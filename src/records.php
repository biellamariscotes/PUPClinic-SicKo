...
$selectedAcademicYear = isset($_GET['academic_year']) ? intval($_GET['academic_year']) : date('Y');
$startYear = '';
$endYear = '';
$startDate = '';
$endDate = '';
...
switch ($sortingCriteria) {
    case 'annually':
        ...
        break;
    case 'daily': // Change 'monthly' to 'daily'
        if (!empty($selectedAcademicYear)) {
            $whereClause = " WHERE YEAR(date) = $selectedAcademicYear AND MONTH(date) = MONTH(CURDATE()) AND DAY(date) = DAY(CURDATE())";
        }
        break;
    case 'weekly':
        if (!empty($selectedAcademicYear)) {
            $whereClause = " WHERE YEAR(date) = $selectedAcademicYear AND WEEK(date) = WEEK(CURDATE())";
        }
        break;
    default:
        if (!empty($selectedAcademicYear)) {
...
$query = "SELECT * FROM treatment_record $whereClause LIMIT $offset, $recordsPerPage";
...
<body>
    ...
    <div class="main-content" style="overflow-x: hidden;">
        ...
        <div class="modal" id="downloadModal" tabindex="-1" role="dialog" data-bs-backdrop="static"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <div class="modal-subtitle" style="justify-content: center;">Are you sure you want to download
                            this file?</div>
                    </div>
                    <div class="modal-buttons" style="padding-bottom: 2rem;">
                        <button type="button" class="btn btn-secondary" id="cancel-download" data-dismiss="modal"
                            style="background-color: #777777; font-family: 'Poppins'; font-weight: bold; padding: 0.070rem 1.25rem 0.070rem 1.25rem; margin-right: 1.25rem;">Cancel</button>
                        <button type="button" class="btn btn-secondary" id="confirm-download" data-dismiss="modal"
                            style="background-color: #058789; font-family: 'Poppins'; font-weight: bold; padding: 0.070rem 1.25rem 0.070rem 1.25rem;">Confirm</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal" id="download-successful-modal" tabindex="-1" role="dialog" data-bs-backdrop="static"
            data-bs-keyboard="false">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <div class="modal-subtitle" style="text-wrap: pretty; justify-content: center;">Your file has
                            been successfully downloaded.</div>
                    </div>
        ...
        <div class="modal" id="confirmDeleteModal" tabindex="-1" role="dialog" data-bs-backdrop="static"
            data-bs-keyboard="false">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <div class="modal-subtitle" style="justify-content: center; padding-bottom: 1rem;">Are you sure
                            you want to delete the selected record(s)? This action cannot be undone.</div>
                    </div>
                    <div class="modal-buttons" style="padding-top: 1rem;">
                        ...
                        <button type="button" class="btn btn-secondary" id="confirm-delete"
        ...
        <div class="content" id="content">
                    ...
                    <div class="medreports-sorting-button" id="medReportsortingButton">
                        <form method="GET">
                            ...
                            <select name="academic_year" id="medReportsortCriteria"
                                ...
                                <option value="2025" <?php echo $selectedAcademicYear == '2025' ? 'selected' : ''; ?>>
                                    2025</option>
                                <option value="2024" <?php echo $selectedAcademicYear == '2024' ? 'selected' : ''; ?>>
                                    2024</option>
                                <option value="2023" <?php echo $selectedAcademicYear == '2023' ? 'selected' : ''; ?>>
                                    2023</option>
                                <option value="2022" <?php echo $selectedAcademicYear == '2022' ? 'selected' : ''; ?>>
                                    2022</option>
                            </select>
                        </form>
                    </div>
            ...
            <div class="table-container">
                <form method="POST">
                    <table class="dashboard-table" style="margin-bottom: 80px;">
                            ...
                            <td colspan="5" style="background-color: white;">
                                <div class="table-button-container">
                                    <div class="button-group">
                                        <span class="delete-records-link" id="delete-toggle-link"
                                            onclick="toggleDeleteMode()" style="color: #D22B2B;">
                                            <i class="bi bi-trash"
                                                style="color: #D22B2B; font-size: 1rem; margin-right: 0.625rem; vertical-align: middle;"></i>
                                            Delete Records
                                        </span>
                                        <span class="delete-records-link" id="delete-selected-link"
                                            style="display: none; color: #D22B2B; margin-right: 10px;"
                                            onclick="$('#confirmDeleteModal').modal('show');">Delete Selected</span>
                                        <div class="button-separator"></div>
                                        <span class="delete-records-link" id="cancel-delete-link"
                                            style="display: none; margin-left: 10px;"
                                            onclick="cancelDeleteMode()">Cancel</span>
                        ...
                        <?php
                            ...
                            <td colspan='5' style='text-align: center; position: relative;'>
                                ...
                                <p style='margin-top: 0.938rem;''>No treatment records found.</p>
                    ...
                    <button type="submit" id="confirmDeleteButton" name="confirmDeleteButton"
                        style="display:none;">Confirm Delete</button>
                </form>
            </div>
        </div>
    </div>
                    ...
                    <div class="alter-second-row">
                        <div class="leading-diagnosis-box">
                            <div class="leading-diagnosis-box-text">
                                <div class="leading-diagnosis-text" style="font-size: 35px;">
