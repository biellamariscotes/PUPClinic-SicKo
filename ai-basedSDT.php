...
<body>
    ...
    <div class="symptomps-header">
        <p class="bold" style="color: #E13F3D; font-size: 40px; font-family: 'Poppins', sans-serif; text-align: left; margin-left: 200px;">Type symptoms...</p>
    </div>
    ...
    <div class="generate-diagnosis-box">
        <div class="generate-diagnosis-text" onclick="window.location.href='dashboard.php'">Generate Diagnosis</div>
    </div>
